...
public class Pneumatics extends Subsystem
{
	...
	public Pneumatics()
	{
		arms = new DoubleSolenoid(RobotMap.PCM_1, RobotMap.SOLENOID_ARM_EXTEND_PORT,
				RobotMap.SOLENOID_ARM_RETRACT_PORT);
		kicker = new DoubleSolenoid(RobotMap.PCM_1, RobotMap.SOLENOID_KICKER_EXTEND_PORT,
				RobotMap.SOLENOID_KICKER_RETRACT_PORT);
		isolateKicker = new DoubleSolenoid(RobotMap.PCM_1, RobotMap.SOLENOID_KICKER_AVAILABLE_PORT,
				RobotMap.SOLENOID_KICKER_ISOLATED_PORT);
	}
