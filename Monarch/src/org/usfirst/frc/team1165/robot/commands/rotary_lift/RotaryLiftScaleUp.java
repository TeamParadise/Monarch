...
import static org.usfirst.frc.team1165.robot.subsystems.RotaryLiftPID.RotaryLiftPosition.SCALE_UP;
 ...
 *
 */
public class RotaryLiftScaleUp extends Command
{
	private RotaryLiftPID mRotaryLiftPID = RotaryLiftPID.getInstance();

	public RotaryLiftScaleUp()
	{
	...
	{
		mRotaryLiftPID.setSetpoint(SCALE_UP);
